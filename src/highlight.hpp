...
struct HighlightConfig {
	...
	// Brightness factor of the highlight outlines effect.  高光轮廓效果的亮度系数
	float brightness = 2.55f;
	// Dim brightness factor if the target is downed.  目标倒下后的亮度系数
	float downed_factor = 0.4f;
	// Dim brightness factor if the target is not visible.   透视目标的亮度系数
